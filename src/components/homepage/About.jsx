...
const About = () => {
  return (
    ...
    <div className="  px-8 lg:py-20 mt-20 flex flex-col lg:flex-row items-center  lg:space-x-10   ">
      ...
      <Link to={'/about'}> <button className="bg-orange text-gray-200 px-10 py-3 rounded-full text-base font-semibold">Read More</button></Link> 
      </div>
...
<Link to={'/about'}> <button className="bg-orange text-base text-gray-200 px-10 py-3 rounded-full font-semibold">Read More</button></Link> 
</div>
...
<Link to={'/donation'}> <button className="text-base bg-orange text-gray-200 px-10 py-3 rounded-full font-semibold">Read More</button></Link> 
</div>
