...
const Contact = () => {
  ...
  return (
    <div className="pt-10 flex flex-col lg:flex-row items-center justify-between">
      <div className="  py-16 rounded   max-w-sm   md:max-w-2xl lg:max-w-5xl xl:max-w-6xl  flex flex-col lg:flex-row container mx-auto">
        ...
        <div className="lg:w-1/2 lg:pr-8">
          <h2 className="text-2xl lg:text-2xl font-bold mb-4 font-poppins text-orange-500">Contact Details</h2>

          <div className='flex gap-2 items-start py-2'>
            <FaLocationDot size={30} color='orange' />
            <p className="">
              <span className=" text-sm lg:text-base font-poppins"></span> SWAMI AJARANAND ANDH VIDYALAYA HIGH SCHOOL , <br />
          ...
          <div className='flex gap-2 items-start py-2'>
            ...
            <p className="">
              <span className=" text-sm lg:text-base font-poppins"></span>0091-1334-260203, 216409, 216410
            ...
            <p className="">
              <span className=" text-sm lg:text-base font-poppins"></span>info@ajarblindschool.com
         
            </p>
          </div>

              <div className='flex gap-8 items-center py-8'>
         <p className='opacity-50 text-slate-900 text-sm font-medium font-poppins '>Socail Media</p>
        ...
        <div className="py-8 lg:py-0 lg:w-1/2">
          ...
          <h2 className="text-2xl lg:text-2xl font-bold mb-4 font-poppins text-orange-500">Contact Us</h2>
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="name" className="block text-sm font-semibold font-poppins text-gray-600">
                Name:
              </label>
            ...
            <div className="mb-4">
              <label htmlFor="email" className="block text-sm font-semibold text-gray-600 font-poppins">
                E-mail Address:
              </label>
            ...
            <div className="mb-4">
              <label htmlFor="mobilenumber" className="block text-sm font-semibold text-gray-600 font-poppins">
                Mobile Number
              </label>
              ...
              {mobileError && <p className="text-red-500 font-poppins">{mobileError}</p>}
            </div>

            <div className="mb-4">
  <label htmlFor="writemessage" className="block text-sm font-semibold text-gray-600 font-poppins">
    Write Message
  </label>
  <textarea
    id="writemessage"
...
{submitError && <p className="text-red-500 my-4 font-poppins">{submitError}</p>}

            <button
              type="submit"
              className="font-poppins bg-orange-500 rounded-3xl text-white py-2 px-4 hover:bg-gray-900 transition-all duration-300"
            >
              Send Message
            </button>
